**NOTE**: This is a fork of `vscode-spell-check` extension developed by [@seanmcbreen](https://github.com/seanmcbreen). The author has deprecated the original extension.
